...
FOR /L %%i IN (1,1,31) DO (
    IF %%i LSS 10 (SET "SUB_ID=sub-0%%i") ELSE (SET "SUB_ID=sub-%%i")
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 1 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 2 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 2.5 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 3 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 4 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 5 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 6 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 7 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
    ...
    IF %ERRORLEVEL% NEQ 0 (ECHO ERROR on Step 8 for !SUB_ID!. Skipping. & GOTO :NEXT_SUB_P1)
